...
/// 程序信息
const int     VER_CODE = 100;
const QString VER_NAME = "V 1.0.0-alpha";
...
/// 本项目的相关链接
const QUrl TEST_URL    = QUrl("https://mock.apifox.cn/m1/7sssss36722-0-default");
...
const QUrl MANUL_URL   = QUrl("https://gitee.com/Alpherk/NjtechAutoLogin/raw/main/docs/prj_info/usr_manual.md");
const QUrl PUSH_MSAG   = QUrl("https://gitee.com/Alpherk/NjtechAutoLogin/raw/main/docs/prj_info/push_msg.md");
const QUrl UPDATE_LOG   = QUrl("https://gitee.com/Alpherk/NjtechAutoLogin/raw/main/docs/prjInfo/update_log,md");
